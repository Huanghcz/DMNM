...
# 从Excel读取数据
df = pd.read_excel('E:/python_lab/DMNM/result.xlsx')  # 替换 'your_excel_file.xlsx' 为您的Excel文件路径

# 每隔140个数据点选择一个点
selected_data = df.iloc[::200, :]

# 绘制折线图
plt.plot(selected_data['Function1 Values'], selected_data['Function2 Values'], marker='o', linestyle='-', color='black')
