...
"""
the final result is [0.8901716  2.55438979],the funtion value is[7.15281361 7.32780096],the iteration number is 3054
Elapsed time: 6.3302531242370605 seconds
...
x = np.array([3.0, 3.0])  # Define x as a float64 array
