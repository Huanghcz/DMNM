...
"""
the final result is [1.19463834 2.40268874],the funtion value is[ 7.20007397 49.19476498],the iteration number is 1796
Elapsed time: 3.1869659423828125 seconds
...
x = np.array([2.0,4.0])  # Define x as a float64 array
