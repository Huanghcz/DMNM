...
# Load initial points from the Excel file
solution_df = pd.read_excel('E:\python_lab\APEG\EAGM-for-MOP_test\iteration_results3.xlsx')
solution_points = solution_df[['X1', 'X2']].to_numpy()
...
for point in solution_points:
    optimized_result,j,elapsed_time = main(point,var_e=1e-3,delta=1e-3,c=0.25,t0=1)
    f110 = f1(point)
    f220 = f2(point)
